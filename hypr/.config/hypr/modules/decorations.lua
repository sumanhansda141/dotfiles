...
hl.config({
	general = {
		...
		col = {
			active_border = "rgb(259185)",
			inactive_border = "rgba(465a61cc)",
		},
	...
	group = {
		...
		-- Group Window Borders
		["col.border_active"] = "rgb(259185)",
		["col.border_inactive"] = "rgba(465a61cc)",

		-- Locked Group Window Borders
		["col.border_locked_active"] = "rgb(d01b24)",
		["col.border_locked_inactive"] = "rgba(d01b2488)",

		-- Tab Bar Customization
		groupbar = {
			-- Active Tab
			["col.active"] = "rgba(002731ee)",

			-- Inactive Tabs
			["col.inactive"] = "rgba(000000dd)",
...
-- Bezier curves kept minimal since animations are disabled above;
-- left in place in case you want to re-enable specific ones later.
...
-- All animation leaves set to enabled = false to match awesome's instant redraws.
